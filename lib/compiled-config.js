...
const rules = {
  ...
  "camunda-compat/duplicate-execution-listener-headers": "error",
  ...
  "camunda-compat/feel-compatibility": "error",
  ...
  "camunda-compat/no-business-id": "error",
  ...
  "camunda-compat/unresolvable-secret-reference": "error",
...
import rule_29 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-business-id';

cache['bpmnlint-plugin-camunda-compat/no-business-id'] = rule_29;

import rule_30 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-before-all-execution-listener';

cache['bpmnlint-plugin-camunda-compat/no-before-all-execution-listener'] = rule_30;

import rule_31 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-candidate-users';

cache['bpmnlint-plugin-camunda-compat/no-candidate-users'] = rule_31;

import rule_32 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-cancel-execution-listener';

cache['bpmnlint-plugin-camunda-compat/no-cancel-execution-listener'] = rule_32;

import rule_33 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-execution-listener-headers';

cache['bpmnlint-plugin-camunda-compat/no-execution-listener-headers'] = rule_33;

import rule_34 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-execution-listeners';

cache['bpmnlint-plugin-camunda-compat/no-execution-listeners'] = rule_34;

import rule_35 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-expression';

cache['bpmnlint-plugin-camunda-compat/no-expression'] = rule_35;

import rule_36 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-interrupting-event-subprocess';

cache['bpmnlint-plugin-camunda-compat/no-interrupting-event-subprocess'] = rule_36;

import rule_37 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-job-priority-definition';

cache['bpmnlint-plugin-camunda-compat/no-job-priority-definition'] = rule_37;

import rule_38 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-loop';

cache['bpmnlint-plugin-camunda-compat/no-loop'] = rule_38;

import rule_39 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-multiple-none-start-events';

cache['bpmnlint-plugin-camunda-compat/no-multiple-none-start-events'] = rule_39;

import rule_40 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-priority-definition';

cache['bpmnlint-plugin-camunda-compat/no-priority-definition'] = rule_40;

import rule_41 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-propagate-all-parent-variables';

cache['bpmnlint-plugin-camunda-compat/no-propagate-all-parent-variables'] = rule_41;

import rule_42 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-signal-event-sub-process';

cache['bpmnlint-plugin-camunda-compat/no-signal-event-sub-process'] = rule_42;

import rule_43 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-task-schedule';

cache['bpmnlint-plugin-camunda-compat/no-task-schedule'] = rule_43;

import rule_44 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-task-listeners';

cache['bpmnlint-plugin-camunda-compat/no-task-listeners'] = rule_44;

import rule_45 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-template';

cache['bpmnlint-plugin-camunda-compat/no-template'] = rule_45;

import rule_46 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-version-tag';

cache['bpmnlint-plugin-camunda-compat/no-version-tag'] = rule_46;

import rule_47 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-zeebe-properties';

cache['bpmnlint-plugin-camunda-compat/no-zeebe-properties'] = rule_47;

import rule_48 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/no-zeebe-user-task';

cache['bpmnlint-plugin-camunda-compat/no-zeebe-user-task'] = rule_48;

import rule_49 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/priority-definition';

cache['bpmnlint-plugin-camunda-compat/priority-definition'] = rule_49;

import rule_50 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/zeebe-user-task';

cache['bpmnlint-plugin-camunda-compat/zeebe-user-task'] = rule_50;

import rule_51 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/secrets';

cache['bpmnlint-plugin-camunda-compat/secrets'] = rule_51;

import rule_52 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/sequence-flow-condition';

cache['bpmnlint-plugin-camunda-compat/sequence-flow-condition'] = rule_52;

import rule_53 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/signal-reference';

cache['bpmnlint-plugin-camunda-compat/signal-reference'] = rule_53;

import rule_54 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/start-event-form';

cache['bpmnlint-plugin-camunda-compat/start-event-form'] = rule_54;

import rule_55 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/start-event-form-embedded';

cache['bpmnlint-plugin-camunda-compat/start-event-form-embedded'] = rule_55;

import rule_56 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/subscription';

cache['bpmnlint-plugin-camunda-compat/subscription'] = rule_56;

import rule_57 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/task-listener';

cache['bpmnlint-plugin-camunda-compat/task-listener'] = rule_57;

import rule_58 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/task-schedule';

cache['bpmnlint-plugin-camunda-compat/task-schedule'] = rule_58;

import rule_59 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/timer';

cache['bpmnlint-plugin-camunda-compat/timer'] = rule_59;

import rule_60 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/unresolvable-secret-reference';

cache['bpmnlint-plugin-camunda-compat/unresolvable-secret-reference'] = rule_60;

import rule_61 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/user-task-definition';

cache['bpmnlint-plugin-camunda-compat/user-task-definition'] = rule_61;

import rule_62 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/user-task-form';

cache['bpmnlint-plugin-camunda-compat/user-task-form'] = rule_62;

import rule_63 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/variable-name';

cache['bpmnlint-plugin-camunda-compat/variable-name'] = rule_63;

import rule_64 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/version-tag';

cache['bpmnlint-plugin-camunda-compat/version-tag'] = rule_64;

import rule_65 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/wait-for-completion';

cache['bpmnlint-plugin-camunda-compat/wait-for-completion'] = rule_65;

import rule_66 from 'bpmnlint/rules/start-event-required';

cache['bpmnlint/start-event-required'] = rule_66;

import rule_67 from 'bpmnlint/rules/ad-hoc-sub-process';

cache['bpmnlint/ad-hoc-sub-process'] = rule_67;

import rule_68 from 'bpmnlint/rules/conditional-event';

cache['bpmnlint/conditional-event'] = rule_68;

import rule_69 from 'bpmnlint/rules/event-based-gateway';

cache['bpmnlint/event-based-gateway'] = rule_69;

import rule_70 from 'bpmnlint/rules/event-sub-process-typed-start-event';

cache['bpmnlint/event-sub-process-typed-start-event'] = rule_70;

import rule_71 from 'bpmnlint/rules/link-event';

cache['bpmnlint/link-event'] = rule_71;

import rule_72 from 'bpmnlint/rules/no-duplicate-sequence-flows';

cache['bpmnlint/no-duplicate-sequence-flows'] = rule_72;

import rule_73 from 'bpmnlint/rules/sub-process-blank-start-event';

cache['bpmnlint/sub-process-blank-start-event'] = rule_73;

import rule_74 from 'bpmnlint/rules/single-blank-start-event';

cache['bpmnlint/single-blank-start-event'] = rule_74;
