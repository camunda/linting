...
import rule_49 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/variable-name';

cache['bpmnlint-plugin-camunda-compat/variable-name'] = rule_49;

import rule_50 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/version-tag';

cache['bpmnlint-plugin-camunda-compat/version-tag'] = rule_50;

import rule_51 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/wait-for-completion';

cache['bpmnlint-plugin-camunda-compat/wait-for-completion'] = rule_51;

import rule_52 from 'bpmnlint/rules/start-event-required';

cache['bpmnlint/start-event-required'] = rule_52;

import rule_53 from 'bpmnlint/rules/ad-hoc-sub-process';

cache['bpmnlint/ad-hoc-sub-process'] = rule_53;

import rule_54 from 'bpmnlint/rules/conditional-event';

cache['bpmnlint/conditional-event'] = rule_54;

import rule_55 from 'bpmnlint/rules/event-based-gateway';

cache['bpmnlint/event-based-gateway'] = rule_55;

import rule_56 from 'bpmnlint/rules/event-sub-process-typed-start-event';

cache['bpmnlint/event-sub-process-typed-start-event'] = rule_56;

import rule_57 from 'bpmnlint/rules/link-event';

cache['bpmnlint/link-event'] = rule_57;

import rule_58 from 'bpmnlint/rules/no-duplicate-sequence-flows';

cache['bpmnlint/no-duplicate-sequence-flows'] = rule_58;

import rule_59 from 'bpmnlint/rules/sub-process-blank-start-event';

cache['bpmnlint/sub-process-blank-start-event'] = rule_59;

import rule_60 from 'bpmnlint/rules/single-blank-start-event';

cache['bpmnlint/single-blank-start-event'] = rule_60;