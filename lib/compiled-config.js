...
import rule_60 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/user-task-definition';

cache['bpmnlint-plugin-camunda-compat/user-task-definition'] = rule_60;

import rule_61 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/user-task-form';

cache['bpmnlint-plugin-camunda-compat/user-task-form'] = rule_61;

import rule_62 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/variable-name';

cache['bpmnlint-plugin-camunda-compat/variable-name'] = rule_62;

import rule_63 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/version-tag';

cache['bpmnlint-plugin-camunda-compat/version-tag'] = rule_63;

import rule_64 from 'bpmnlint-plugin-camunda-compat/rules/camunda-cloud/wait-for-completion';

cache['bpmnlint-plugin-camunda-compat/wait-for-completion'] = rule_64;

import rule_65 from 'bpmnlint/rules/start-event-required';

cache['bpmnlint/start-event-required'] = rule_65;

import rule_66 from 'bpmnlint/rules/ad-hoc-sub-process';

cache['bpmnlint/ad-hoc-sub-process'] = rule_66;

import rule_67 from 'bpmnlint/rules/conditional-event';

cache['bpmnlint/conditional-event'] = rule_67;

import rule_68 from 'bpmnlint/rules/event-based-gateway';

cache['bpmnlint/event-based-gateway'] = rule_68;

import rule_69 from 'bpmnlint/rules/event-sub-process-typed-start-event';

cache['bpmnlint/event-sub-process-typed-start-event'] = rule_69;

import rule_70 from 'bpmnlint/rules/link-event';

cache['bpmnlint/link-event'] = rule_70;

import rule_71 from 'bpmnlint/rules/no-duplicate-sequence-flows';

cache['bpmnlint/no-duplicate-sequence-flows'] = rule_71;

import rule_72 from 'bpmnlint/rules/sub-process-blank-start-event';

cache['bpmnlint/sub-process-blank-start-event'] = rule_72;

import rule_73 from 'bpmnlint/rules/single-blank-start-event';

cache['bpmnlint/single-blank-start-event'] = rule_73;
