...
import rule_54 from 'bpmnlint/rules/event-based-gateway';

cache['bpmnlint/event-based-gateway'] = rule_54;

import rule_55 from 'bpmnlint/rules/event-sub-process-typed-start-event';

cache['bpmnlint/event-sub-process-typed-start-event'] = rule_55;

import rule_56 from 'bpmnlint/rules/link-event';

cache['bpmnlint/link-event'] = rule_56;

import rule_57 from 'bpmnlint/rules/no-duplicate-sequence-flows';

cache['bpmnlint/no-duplicate-sequence-flows'] = rule_57;

import rule_58 from 'bpmnlint/rules/sub-process-blank-start-event';

cache['bpmnlint/sub-process-blank-start-event'] = rule_58;

import rule_59 from 'bpmnlint/rules/single-blank-start-event';

cache['bpmnlint/single-blank-start-event'] = rule_59;