...
function getSecretExpressionFormatDeprecatedErrorMessage(report, executionPlatformVersion) {
  ...
  if (allowedVersion && executionPlatformVersion && greaterOrEqual(executionPlatformVersion, allowedVersion)) {
    return `Property <${ property }> uses deprecated secret expression format secrets.SECRET or {{secrets.SECRET}}, migrate to secret resolution: https://docs.camunda.io/docs/next/components/concepts/secret-resolution/`;
  }
